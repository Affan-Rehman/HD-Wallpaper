...
public class FragmentWallDownloaded extends Fragment {
    ...
    private void getWallpaperData() {
        if (methods.isNetworkAvailable()) {
            ...
            Call<ItemWallpaperList> call = APIClient.getClient().create(APIInterface.class).getWallpapersByDownload(methods.getAPIRequest(Constant.URL_WALLPAPER_BY_DOWNLOAD, 0, color_ids, wallType, "", "", "", "", "", "", "", "", new SharedPref(getActivity()).getUserId(), ""));
            ...
            arrayList = dbHelper.getWallpapers("download", wallType);
            setAdapter();
