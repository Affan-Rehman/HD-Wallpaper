...
public class FragmentWallPopular extends Fragment {
    ...
    private void getWallpaperData() {
        if (methods.isNetworkAvailable()) {
            ...
            Call<ItemWallpaperList> call = APIClient.getClient().create(APIInterface.class).getWallpapersByPopular(methods.getAPIRequest(Constant.URL_WALLPAPER_BY_POPULAR, 0, color_ids, wallType, "", "", "", "", "", "", "", "", new SharedPref(getActivity()).getUserId(), ""));
            ...
            arrayList = dbHelper.getWallpapers("views", wallType);
            setAdapter();
