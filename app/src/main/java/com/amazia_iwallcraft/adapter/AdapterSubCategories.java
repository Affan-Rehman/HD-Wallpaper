...
public class AdapterSubCategories extends RecyclerView.Adapter {

    Context context;
    Methods methods;
    ArrayList<ItemSubCat> arrayList, filteredArrayList;
    int selectedPos = -1;
    ...
    public AdapterSubCategories(Context context, ArrayList<ItemSubCat> arrayList) {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {
        ...
        if(selectedPos != holder.getAbsoluteAdapterPosition()) {
            ((MyViewHolder) holder).cl_sub_cat.setBackgroundResource(R.drawable.bg_sub_cat_round);
        } else {
            ((MyViewHolder) holder).cl_sub_cat.setBackgroundResource(R.drawable.bg_gradient_round);
        }
    }
